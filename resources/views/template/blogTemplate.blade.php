...
@section('comment')
    <form class="w-full flex flex-col gap-5 border-t-[1px] border-gray-200 pt-2 sticky top-0 bg-white p-5 shadow-md" enctype="multipart/form-data" id="addCommentForm">
